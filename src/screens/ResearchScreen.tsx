...
const s = StyleSheet.create({
  ...
  subtitle: { color: colors.muted, fontSize: typography.footnote, marginTop: 2 },
  searchBar: { flexDirection: 'row', gap: spacing.sm, padding: spacing.md, backgroundColor: colors.cardSolid, borderBottomWidth: 1, borderBottomColor: colors.border },
  input: { flex: 1, backgroundColor: colors.background, borderRadius: radius.md, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, color: colors.foreground, fontSize: typography.subheadline, borderWidth: 1, borderColor: colors.border },
  ...
  searchBtnText: { color: '#fff', fontWeight: fontWeight.bold, fontSize: typography.sm },
  modeRow: { flexDirection: 'row', gap: spacing.sm, padding: spacing.sm, backgroundColor: colors.cardSolid, borderBottomWidth: 1, borderBottomColor: colors.border },
  ...
  modeBtnText: { color: colors.muted, fontSize: typography.footnote, fontWeight: fontWeight.semibold },
  ...
  insightsCard: { backgroundColor: colors.cardSolid, borderRadius: radius.lg, padding: spacing.md, borderWidth: 1, borderColor: colors.primary + '40', gap: spacing.sm },
  insightsTitle: { color: colors.foreground, fontSize: typography.subheadline, fontWeight: fontWeight.bold },
  insightsText: { color: colors.muted, fontSize: typography.footnote, lineHeight: 18 },
  insightsSubtitle: { color: colors.foreground, fontSize: typography.footnote, fontWeight: fontWeight.semibold, marginTop: spacing.xs },
  ...
  resultCard: { backgroundColor: colors.cardSolid, borderRadius: radius.lg, padding: spacing.md, borderWidth: 1, borderColor: colors.borderSolid, gap: spacing.sm },
  resultCardSelected: { borderColor: colors.primary },
  resultHeader: { flexDirection: 'row', alignItems: 'flex-start', gap: spacing.sm },
  resultTitle: { color: colors.foreground, fontSize: typography.subheadline, fontWeight: fontWeight.semibold, flex: 1, lineHeight: 20 },
  resultLink: { color: colors.primary, fontSize: typography.title3, fontWeight: fontWeight.bold },
  resultSnippet: { color: colors.muted, fontSize: typography.footnote, lineHeight: 18 },
  ...
  descTitle: { color: colors.foreground, fontSize: typography.footnote, fontWeight: fontWeight.bold },
  descText: { color: colors.muted, fontSize: typography.footnote, lineHeight: 18 },
  copyBtn: { backgroundColor: colors.primary, borderRadius: radius.sm, padding: spacing.sm, alignItems: 'center' },
  copyBtnText: { color: '#fff', fontSize: typography.footnote, fontWeight: fontWeight.bold },
  sectionTitle: { color: colors.foreground, fontSize: typography.body, fontWeight: fontWeight.bold },
  empty: { alignItems: 'center', padding: spacing.xl },
  emptyText: { color: colors.muted, fontSize: typography.sm },
  historyRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, backgroundColor: colors.cardSolid, borderRadius: radius.lg, padding: spacing.md, borderWidth: 1, borderColor: colors.border },
  historyTitle: { color: colors.foreground, fontSize: typography.subheadline, fontWeight: fontWeight.semibold },
  historySub: { color: colors.muted, fontSize: typography.footnote, marginTop: 2 },
