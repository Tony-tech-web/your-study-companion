...
const s = StyleSheet.create({
  ...
  summaryCard: { flex: 1, backgroundColor: colors.cardSolid, borderRadius: radius.lg, padding: spacing.md, alignItems: 'center', borderWidth: 1, borderColor: colors.border },
  summaryValue: { color: colors.primary, fontSize: typography.title1, fontWeight: fontWeight.black },
  summaryLabel: { color: colors.muted, fontSize: typography.footnote, marginTop: 2 },
  summaryClass: { color: colors.foreground, fontSize: 10, fontWeight: fontWeight.semibold, marginTop: 2 },
  recordCard: { backgroundColor: colors.cardSolid, borderRadius: radius.lg, padding: spacing.md, borderWidth: 1, borderColor: colors.borderSolid, gap: spacing.sm },
  recordHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  recordSemester: { color: colors.foreground, fontSize: typography.body, fontWeight: fontWeight.bold },
  recordClass: { color: colors.muted, fontSize: typography.footnote, marginTop: 2 },
  recordRight: { flexDirection: 'row', alignItems: 'center', gap: spacing.md },
  recordGpa: { fontSize: typography.title1, fontWeight: '900' },
  ...
  label: { color: colors.muted, fontSize: typography.footnote, fontWeight: fontWeight.semibold, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 4 },
